...
(deftest intcode-program
  ...
  (testing "Day 9 Parameter mode 2 and opscode 9"
    ...
    (is (= [1219070632396864] (run-intcode [1102 34915192 34915192 7 4 7 99 0] []))))
    (is (= [1125899906842624] (run-intcode [104,1125899906842624,99] [])))
  )
